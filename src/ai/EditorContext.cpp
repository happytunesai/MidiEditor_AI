...
QString EditorContext::ffxivContext()
{
    return QStringLiteral(
        ...
        "- Each track is MONOPHONIC — only ONE note sounding at a time. Never overlap notes.\n"
        ...
        "\n"
        "### Composing Tips\n"
        "- Use arpeggios instead of chords — monophonic tracks cannot play chords.\n"
        ...
        "  only (deep roars, high-pitch screeches, harmonics), NOT a playable guitar.\n"
        "  Use ElectricGuitarClean, ElectricGuitarMuted, ElectricGuitarOverdriven, or\n"
        "  ElectricGuitarPowerChords as the main guitar track. Switch individual notes\n"
        "  to ElectricGuitarSpecial via channel override for effect accents only.\n"
    );
}
...
QString EditorContext::ffxivContextCompact()
{
    return QStringLiteral(
        ...
        "- Max 8 tracks (octet). Each track MONOPHONIC (no overlapping notes).\n"
        ...
        "\n"
        "### Tips\n"
        "- Arpeggios not chords. Simple drum patterns. Clarity over complexity.\n"
