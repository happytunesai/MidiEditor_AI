...
QString EditorContext::agentSystemPrompt()
{
    ...
    return QStringLiteral(
        ...
        "- To delete specific events from the user's current selection (e.g. 'delete every\n"
        "  second selected note'), use delete_events_by_index with the 0-based indices into\n"
        "  the selectedEvents array (e.g. [1,3,5,...]). Prefer this over deleting one tick at\n"
        "  a time or rewriting the whole region.\n"
