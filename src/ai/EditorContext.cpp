...
QString EditorContext::ffxivContextCompact()
{
    ...
    return QStringLiteral(
        ...
        "- Each track needs its own unique channel with program_change at tick 0.\n"
        "- You can use as many channels (0-15, excluding 9) as needed.\n"
        "  Guitar switches each need their own channel. No channel limit.\n"
        "\n"
